...
#define TI_UNS_DEFAULT	0x00000000	// значение по умолчанию дл€ типа integer
...
{
	enum IDDATATYPE {DEF = 0, UNS = 1, INT = 2, STR = 3, VOI = 4 };			// типы данных идентификаторов: integer, string
	enum IDTYPE { D = 0, V = 1, F = 2, P = 3, L = 4, OP = 5, VF = 6};	// типы идентификаторов: переменна€, функци€, параметр, литерал, оператор, переменна€ в условном операторе
	...
	struct Entry	// строка таблицы идентификаторов
	{
		...
		union
		{
			...
			unsigned int vuint;         // значение unsigned integer

			char operation;             //операци€
